...
def user_choice(request):
    ...
    if user_choice == "Metal":
        if computer == "Wood":
            ...
            return redirect('game_page')
        if computer == "Earth":
            messages.success(request, 'Metal Beats Earth, you win :)')
            return redirect('game_page')
        if computer == "Water":
            messages.success(request, 'Water Beats Metal, you lose :)')
            return redirect('game_page')        
        if computer == "Fire":
    ...
    if user_choice == "Earth":
        if computer == "Water":
            ...
            return redirect('game_page')
        if computer == "Fire":
            messages.success(request, 'Earth Beats Fire, you win :)')
            return redirect('game_page')
        if computer == "Wood":
            messages.success(request, 'Wood Beats Earth, you lose :(')
            return redirect('game_page')
        if computer == "Metal":
            messages.success(request, 'Metal Beats Earth, you lose :(')
            return redirect('game_page')
        else:
            messages.success(request, 'No winner this round!!')
            return redirect('game_page')
    if user_choice == "Water":
        if computer == "Fire":
            ...
            return redirect('game_page')
        if computer == "Metal":
            messages.success(request, 'Water Beats Metal, you win :)')
            return redirect('game_page')
        if computer == "Earth":
            messages.success(request, 'Earth Beats Water, you lose :(')
            return redirect('game_page')
        if computer == "Wood":
            messages.success(request, 'Wood Beats Water, you lose :(')
            return redirect('game_page')
        else:
            messages.success(request, 'No winner this round!!')
            return redirect('game_page')
    if user_choice == "Fire":
        if computer == "Metal":
            ...
            return redirect('game_page')
        if computer == "Wood":
            messages.success(request, 'Fire Beats Wood, you win :)')
            return redirect('game_page')
        if computer == "Water":
            messages.success(request, 'Water Beats Fire, you lose :(')
            return redirect('game_page')
        if computer == "Earth":
            messages.success(request, 'Water Beats Earth, you lose :(')
            return redirect('game_page')
        else:
            messages.success(request, 'No winner this round!!')
            return redirect('game_page')
    if user_choice == "Wood":
        if computer == "Earth":
            ...
            return redirect('game_page')
        if computer == "Water":
            messages.success(request, 'Wood Beats Water, you win :)')
            return redirect('game_page')
        if computer == "Metal":
            messages.success(request, 'Metal Beats Wood, you lose :(')
            return redirect('game_page')
        if computer == "Fire":
            messages.success(request, 'Metal Beats Fire, you lose :(')
            return redirect('game_page')
        else:
            messages.success(request, 'No winner this round!!')
            return redirect('game_page')
